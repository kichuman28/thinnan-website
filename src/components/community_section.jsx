    ...
    <section id="community" className="py-16 md:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Food Community</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <div className="relative bg-white rounded-2xl shadow-md p-8 md:p-10 overflow-hidden">
              <div className="absolute top-0 left-0 w-20 h-20 bg-thinnan-orange opacity-10 rounded-br-3xl"></div>
              
              <div className="relative">
                <svg className="w-12 h-12 text-thinnan-orange opacity-20 mb-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="flex space-x-2">
                    {testimonials.map((_, index) => (
                      <button
                        ...
                        className={`w-2.5 h-2.5 rounded-full ${index === activeIndex ? 'bg-thinnan-orange' : 'bg-gray-300'}`}
          ...
          <div className="order-1 md:order-2">
            <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="flex">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg key={star} className={`w-4 h-4 ${star <= 4 ? 'text-thinnan-orange' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="bg-gradient-to-br from-thinnan-orange to-orange-600 rounded-2xl shadow-md overflow-hidden text-white">
                <div className="p-6">
                  ...
                  <a href="#download" className="block w-full bg-white text-thinnan-orange font-semibold py-3 rounded-lg text-center hover:bg-opacity-90 transition-colors">
                    Download the App
                  </a>
                </div>
              </div>
