...
const CommunitySection = () => {
  ...
  return (
    <section id="community" className="py-16 md:py-24 relative overflow-hidden bg-gray-dark">
      {/* Background patterns */}
      ...
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-accent opacity-20 rounded-full blur-2xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        <div className="text-center mb-16 relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-accent opacity-20 rounded-full blur-xl"></div>
          <h2 className="section-title relative inline-block text-white">
            Our Food Community
            <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-accent/40 to-transparent"></div>
          </h2>
          <p className="section-subtitle mt-4 text-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="order-2 md:order-1">
            <div className="card p-8 md:p-10 bg-black/40 backdrop-blur-sm bg-opacity-80 relative group overflow-hidden border border-white/10 rounded-2xl">
              ...
              <div className="absolute -left-4 -top-4 w-8 h-8 border border-accent/20 rounded-full opacity-30"></div>
              <div className="absolute -right-4 -bottom-4 w-8 h-8 border border-accent/20 rounded-full opacity-30"></div>
              ...
              <div className="relative">
                ...
                <div className="relative h-[200px] overflow-hidden">
                  {testimonials.map((testimonial, index) => (
                    ...
                    >
                      <p className="text-lg text-gray-300 italic mb-4 relative">
                        <span className="relative">
                          "{testimonial.quote}"
                          <span className="absolute -left-2 -top-2 text-4xl text-accent opacity-20">"</span>
                        </span>
                      </p>
                      
                      <div className="flex items-center">
                        <div className="w-12 h-12 bg-gray-300 rounded-full overflow-hidden mr-4 ring-2 ring-accent/20 shadow-md">
                          <img 
                ...
                <div className="flex justify-between items-center mt-8 border-t pt-4 border-white/10">
                  <button 
                    onClick={prevTestimonial} 
                    className="p-2 rounded-full border border-white/10 hover:border-accent/50 hover:text-accent transition-colors text-white"
          ...
          <div className="order-1 md:order-2">
            <div className="space-y-6">
              <div className="card relative backdrop-blur-sm bg-black/40 group border border-white/10 rounded-2xl">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300">Average event rating</span>
                      <div className="flex items-center">
                        <span className="font-semibold text-white mr-1">4.8</span>
                        <div className="flex">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg key={star} className={`w-4 h-4 ${star <= 4 ? 'text-accent' : 'text-gray-700'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="card overflow-hidden relative rounded-2xl">
