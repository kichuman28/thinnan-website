...
const DownloadSection = () => {
  return (
    <section id="download" className="py-16 md:py-24 bg-gray-900 text-white relative overflow-hidden">
      {/* Background elements */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="text-white relative text-center md:text-left">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 group justify-center md:justify-start">
                ...
                <p className="text-lg group-hover:translate-x-2 transition-transform duration-300">Build lasting connections through shared meals</p>
              </div>
            </div>
          ...
          <div className="relative mt-10 md:mt-0">
            <div className="flex justify-center md:justify-end">
              <div className="relative w-[300px] h-[620px] bg-gradient-to-b from-gray-800 to-black rounded-[40px] p-3 overflow-hidden shadow-2xl border border-gray-700 z-10">
                {/* Phone frame details - removed transform hover effect */}
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-6 bg-black rounded-b-2xl"></div>
                
                <div className="bg-black h-full w-full rounded-[35px] overflow-hidden border border-gray-700 relative">
