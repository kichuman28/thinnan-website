...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="py-16 md:py-24 relative overflow-hidden bg-gray-dark">
      {/* Background elements */}
      ...
      {/* Decorative shapes */}
      <div className="absolute top-40 right-0 w-64 h-64 bg-accent opacity-10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-10 w-40 h-40 bg-accent opacity-10 rounded-full blur-xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group border border-white/10">
              <div className="grid md:grid-cols-5 gap-6">
                ...
                <div className="md:col-span-3 p-6 flex flex-col justify-center">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold ml-4 text-white group-hover:text-accent transition-colors duration-300">Host or Join Cookouts</h3>
                  </div>
                  <p className="text-gray-300">Plan a meal, invite friends, and cook together.</p>
                  <div className="mt-6 flex items-center space-x-4">
                    <div className="flex -space-x-3">
                      {friendImages.slice(0, 3).map((image, index) => (
                        <div key={index} className="w-8 h-8 rounded-full border-2 border-black relative">
                          <img 
                            src={image} 
                            alt={`Friend ${index + 1}`}
                    ...
                    <span className="text-sm text-gray-400">+12 joined today</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-5 gap-6">
                ...
                <div className="md:col-span-3 p-6 flex flex-col justify-center">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold ml-4 text-white group-hover:text-accent transition-colors duration-300">Discover Cookouts</h3>
                  </div>
                  <p className="text-gray-300">Find gatherings hosted by friends or explore new flavors.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {/* Shared Stories */}
            <div className="bg-black/40 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 group border border-white/10">
              ...
              <h3 className="text-lg font-bold mb-2 text-white group-hover:text-accent transition-colors duration-300">Shared Stories</h3>
              <p className="text-gray-300 text-sm">Create collaborative "hamburger posts" with photos and memories.</p>
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 group border border-white/10">
              ...
              <h3 className="text-lg font-bold mb-2 text-white group-hover:text-accent transition-colors duration-300">Build Your Network</h3>
              <p className="text-gray-300 text-sm">Add friends, create groups, and connect over food.</p>
              <div className="mt-4 flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-400">+28 friends</span>
              </div>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 group border border-white/10">
              ...
              <h3 className="text-lg font-bold mb-2 text-white group-hover:text-accent transition-colors duration-300">Earn Badges</h3>
              <p className="text-gray-300 text-sm">Track your culinary journey with country flag badges.</p>
              <div className="mt-4 grid grid-cols-4 gap-2">
                <div className="w-10 h-10 rounded-full bg-black/30 flex items-center justify-center overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 group border border-white/10">
              ...
              <h3 className="text-lg font-bold mb-2 text-white group-hover:text-accent transition-colors duration-300">Create & Inspire</h3>
              <p className="text-gray-300 text-sm">Share dishes and engage with others' experiences.</p>
              <div className="mt-4 flex items-center justify-between text-sm">
                <div className="flex items-center space-x-2">
                  <div className="w-8 h-8 bg-black/30 rounded-full flex items-center justify-center">👨‍🍳</div>
