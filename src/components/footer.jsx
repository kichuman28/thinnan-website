const Footer = () => {
  return (
    <footer className="bg-gray-dark text-white relative overflow-hidden">
      ...
      {/* Left gradient blur */}
      <div className="absolute -left-32 top-1/3 w-48 sm:w-64 h-48 sm:h-64 bg-accent opacity-20 rounded-full blur-3xl"></div>
      
      {/* Right gradient blur */}
      <div className="absolute -right-32 bottom-1/3 w-48 sm:w-64 h-48 sm:h-64 bg-accent opacity-20 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20 py-8 sm:py-12 relative z-10">
        <div className="grid grid-cols-2 sm:grid-cols-6 gap-8 sm:gap-12">
          ...
          <div className="col-span-2 sm:col-span-2">
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">About thinnan</h3>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-4 sm:space-x-6">
              <a href="https://thinnan.page.link/download" className="text-gray-300 hover:text-accent text-xs sm:text-sm transition-colors duration-300">
                Privacy Policy
              </a>
            </div>
          </div>
