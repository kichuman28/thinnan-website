          ...
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#founders" className="text-gray-400 hover:text-white transition-colors">Founders</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">iOS App</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Android App</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Web App</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="mailto:info@thinnan.com" className="text-gray-400 hover:text-white transition-colors">info@thinnan.com</a></li>
              </ul>
            </div>
          </div>
        </div>
